...
public class ContrattoMobile extends ContrattoTelefonico {
	...
	/*
	 * costruisce un contratto con un telefono mobile assegnando un nome e un numero
	 * di telefono all'utente.
	 */
	...
	/*
	 * riscrive il metodo aggiornaBolletta() della superclasse modificandola in
	 * accordo con le tariffe addottate per il telefono mobile.
	 */
